...
INSERT INTO customers (first_name, last_name, display_name, email, password, owned_game_ids, wishlisted_game_id)
VALUES ('John', 'Doe', 'JohnnyDooo', 'JohnDoe@gmail.com', 'password', ARRAY[1,2, 3], ARRAY[4,6]),
       ('Mary', 'Jane', 'MJ', 'janemary@gmail.com', '12345', NULL, ARRAY[4,9, 12]),
       ('Clark', 'Kent', 'Superman', 'imnotsuperman@gmail.com', 'batman', ARRAY[1, 3], ARRAY[4, 9, 12]),
       ('Alice', 'Johnson', 'AJ', 'alice.johnson@example.com', 'alicepass', ARRAY[3, 5, 6], ARRAY[12]),
       ('Michael', 'Smith', 'MSmith', 'michael.smith@example.com', 'smith123', ARRAY[1, 10], ARRAY[4]),
       ('Emily', 'Davis', 'EmDav', 'emily.davis@example.com', 'emily456', ARRAY[1, 2, 3, 4, 6, 9], ARRAY[7, 8]),
       ('William', 'Brown', 'WillyB', 'william.brown@example.com', 'brownie', ARRAY[1, 3, 4, 8], NULL),
       ('Emma', 'Wilson', 'EWilson', 'emma.wilson@example.com', 'emma789', ARRAY[2, 4], ARRAY[6, 10]),
       ('David', 'Brown', 'DBrown', 'david.brown@example.com', 'david123', ARRAY[1], ARRAY[2]),
       ('Sophia', 'Garcia', 'SophG', 'sophia.garcia@example.com', 'sophia456', ARRAY[3], ARRAY[1, 9]);
...
VALUES ('World of Warcraft',
        ...
        49.99, (SELECT publisher_id FROM publishers WHERE name = 'Blizzard'),
       ...
       ('FIFA 22',
        ...
        59.99, (SELECT publisher_id FROM publishers WHERE name = 'Electronic Arts'), 'EA Sports',
       ...
       ('Dark Souls III',
        ...
        59.99, (SELECT publisher_id FROM publishers WHERE name = 'FromSoftware Inc.'), 'FromSoftware Inc.',
        CAST('2016-04-12' AS DATE)),
       ('Elden Ring',
        'THE NEW FANTASY ACTION RPG. Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord in the Lands Between.',
        69.99, (SELECT publisher_id FROM publishers WHERE name = 'FromSoftware Inc.'), 'FromSoftware Inc.',
       ...
       ('Resident Evil Village',
        ...
        59.99, (SELECT publisher_id FROM publishers WHERE name = 'CAPCOM Co., Ltd'), 'CAPCOM',
        CAST('2021-05-07' AS DATE)),
       ('Horizon Forbidden West', 'An action role-playing game', 69.99,
        (SELECT publisher_id FROM publishers WHERE name = 'PlayStation PC LLC'), 'Guerrilla Games',
       ...
       ('Far Cry 6',
        ...
        59.99, (SELECT publisher_id FROM publishers WHERE name = 'Ubisoft'), 'Ubisoft Toronto',
        CAST('2020-03-18' AS DATE)),
       ('Assassin Creed Valhalla', 'An action role-playing game', 59.99,
        (SELECT publisher_id FROM publishers WHERE name = 'Ubisoft'), 'Ubisoft Montreal',
       ...
       ('Bloodborne',
        ...
        19.99, (SELECT publisher_id FROM publishers WHERE name = 'FromSoftware Inc.'), 'FromSoftware Inc.',
       ...
       ('The Legend of Zelda: Breath of the Wild',
        ...
        59.99, (SELECT publisher_id FROM publishers WHERE name = 'Nintendo'), 'Nintendo EPD',
       ...
       ('God of War Ragnarok',
        ...
        69.99, (SELECT publisher_id FROM publishers WHERE name = 'PlayStation PC LLC'), 'Santa Monica Studio', CAST('2018-10-05' AS DATE)),
       ('Overwatch',
        ...
        19.99, (SELECT publisher_id FROM publishers WHERE name = 'Blizzard'), 'Blizzard Entertainment',
       ...
       ('Final Fantasy XIV: Endwalker',
        ...
        39.99, (SELECT publisher_id FROM publishers WHERE name = 'Square Enix'), 'Square Enix',
       ...
       ('Portal 2',
        ...
        29.99, (SELECT publisher_id FROM publishers WHERE name = 'Valve Corporation'), 'Valve Corporation',
       ...
       ('The Legend of Zelda: Skyward Sword HD',
        ...
        49.99, (SELECT publisher_id FROM publishers WHERE name = 'Nintendo'), 'Nintendo EPD',
       ...
       ('StarCraft II: Wings of Liberty',
        ...
        29.99, (SELECT publisher_id FROM publishers WHERE name = 'Blizzard'), 'Blizzard Entertainment',
       ...
       ('Need for Speed: Heat',
        ...
        49.99, (SELECT publisher_id FROM publishers WHERE name = 'Electronic Arts'), 'Ghost Games',
       ...
       ('The Last of Us Part II',
        ...
        59.99, (SELECT publisher_id FROM publishers WHERE name = 'PlayStation PC LLC'), 'Naughty Dog',
...
VALUES (1, currval('transaction_details_transaction_id_seq'), (SELECT game_id FROM games WHERE title = 'World of Warcraft')),
       (1, currval('transaction_details_transaction_id_seq'), (SELECT game_id FROM games WHERE title = 'Assassin Creed Valhalla'));
